...
export const dataItems: DataItem[] = [
  ...
  { id: 7,  title: "乳腺钼靶筛查数据集",          subtitle: "X射线 (X-ray)",           tags: ["乳腺","检测"],      colorLevel: 5, samples: "8.9K",  size: "52 GB",   source: { type: 'platform',     name: 'iMedLoop' },              modality: 'X-ray',  anatomy: ['乳腺'],           scale: 'large', points: 1800 },
  ...
  { id: 9,  title: "眼底图像数据集",              subtitle: "可见光影像 (VL)",         tags: ["眼底","分类"],      colorLevel: 1, samples: "2.4K",  size: "8.6 GB",  source: { type: 'external',     name: 'EyePACS数据联盟' },   modality: 'VL',     anatomy: ['其他'],           scale: 'small', points: 450 },
  ...
  { id: 11, title: "皮肤病变分类",                subtitle: "可见光影像 (VL)",         tags: ["皮肤科"],           colorLevel: 2, samples: "6.3K",  size: "24 GB",   source: { type: 'external',     name: 'DermNet数据库' },      modality: 'VL',     anatomy: ['全身'],           scale: 'medium' },
  ...
  { id: 13, title: "骨骼X光影像库",               subtitle: "X射线 (X-ray)",           tags: ["骨科"],             colorLevel: 3, samples: "4.6K",  size: "28 GB",   source: { type: 'institution',  name: '上海交大附属医院' },   modality: 'X-ray',  anatomy: ['骨骼'],           scale: 'medium' },
  ...
  { id: 15, title: "糖尿病视网膜病变数据集",      subtitle: "可见光影像 (VL)",         tags: ["眼底","分级"],      colorLevel: 6, samples: "1.8K",  size: "6.4 GB",  source: { type: 'institution',  name: '中山眼科中心' },       modality: 'VL',     anatomy: ['其他'],           scale: 'small'  },
  ...
  { id: 21, title: "白内障手术显微影像数据库",    subtitle: "可见光影像 (VL)",         tags: ["眼科"],             colorLevel: 5, samples: "2.1K",  size: "48 GB",   source: { type: 'institution',  name: '天津眼科医院' },       modality: 'VL',     anatomy: ['其他'],           scale: 'medium' },
  ...
  { id: 25, title: "膝关节MRI软骨分割",           subtitle: "磁共振 (MR)",             tags: ["骨科","分割"],      colorLevel: 3, samples: "4.2K",  size: "88 GB",   source: { type: 'institution',  name: '解放军总医院' },       modality: 'MR',     anatomy: ['关节'],           scale: 'large'  },
