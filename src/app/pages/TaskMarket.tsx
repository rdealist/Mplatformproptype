...
const allTasks: Task[] = [
  ...
  { id: 'T023', category: '审核任务', title: '皮肤黑色素瘤分类审核',     description: '对皮肤镜黑色素瘤良恶性标注批次进行专家复审，依据ABCDE标准判定各样本分类是否准确合规',         type: '分类标注',   modality: '皮肤镜',  level: 'Lv2', reward: '1,800',  deadline: '2026-07-01', progress: { current: 30, total: 30 }, status: '已结束', difficulty: '简单' },
  { id: 'T024', category: '审核任务', title: '颈动脉超声斑块检测审核',   description: '复核颈动脉超声斑块检测框标注结果，评估斑块边界勾画精度，对存疑标注进行退回修改或直接修正',     type: '检测标注',   modality: 'US',      level: 'Lv3', reward: '2,400',  deadline: '2026-07-05', progress: { current: 15, total: 15 }, status: '已结束', difficulty: '中等' },
  ...
  { id: 'T029', category: '审核任务', title: '放射科报告结构化审核',     description: '对放射科文字报告NLP标注结果进行审核，核实病变部位、性质等关键实体的抽取是否准确，修正错误标注', type: '文本注',   modality: 'X-Ray',   level: 'Lv1', reward: '1,100',  deadline: '2026-07-16', progress: { current: 25, total: 40 }, status: '进行中', difficulty: '简单' },
